...
class CProductCardHorizontal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String discountedPercentage = "${discountedPrice / price * 100}%";
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: CRoundedImages(
                      isNetworkImage: true,
                      imgUrl: imgPath, applyImgRadius: true),
                ),
              ...
              child: Column(
                children: [
                  Column(
                    ...
                    children: [
                      CProductTitleText(title: productTitle, smallSize: true),
                  ...
                  Row(
                    ...
                    children: [
                      /// Pricing
                      Flexible(child: CProductPriceText(price: discountedPrice.toString())),
